...
* Webhooks can also be added "manually" through the API setup beans in the Vend backend. This beans can be accessed by adding **/setup/api** at the end of the store's URL.
