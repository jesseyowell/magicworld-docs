...
2. [Deploy a node](doc:manage-your-networks#join-a-public-network).
3. [View node access and credentials](doc:manage-your-node#view-node-access-and-credentials).
