---
title: Search REST API v2.0
excerpt: search search search v2.0
deprecated: false
hidden: true
metadata:
  title: ''
...
```bash
$ curl 'http://localhost:8080/api/v1/entities' -i -X GET \
    -H 'IDS-SESSION-ID: dummySessionId'
```
...
```bash
$ curl 'http://localhost:8080/api/v1/searchFacets' -i -X POST \
    -H 'Content-Type: application/json' \
    -H 'IDS-SESSION-ID: dummySesionID' \
    -d '{
    "entityType": "customer",
...
{
  "status" : "OK",
  "startTime" : "11:01:33:793",
  "endTime" : "11:01:33:794",
  "timeTaken" : "1622570493794",
  "searchRequest" : {
    "facetSize" : 10,
    "facetAfter" : {
      "customer.firstName" : "abc"
